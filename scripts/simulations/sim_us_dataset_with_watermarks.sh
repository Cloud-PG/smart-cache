...
python -m SmartCache.sim.simulator plot ../../results/sim_us_dataset_with_watermarks/cache_200T_10Gbit --plot-resolution 1280,800 --cache-bandwidth 10 --export-table 'true'

### ----- Plot tables -----

# python -m Probe.qTable ../../results/sim_us_dataset_with_watermarks/cache_200T_10Gbit/run_full_normal/aiRL_10G_it/aiRL_10G_it_additionQtable.csv &&

# python -m Probe.qTable ../../results/sim_us_dataset_with_watermarks/cache_200T_10Gbit/run_full_normal/aiRL_10G_it/aiRL_10G_it_evictionQtable.csv &