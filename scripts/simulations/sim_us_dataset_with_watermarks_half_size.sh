...
python -m SmartCache.sim.simulator sim ../../datasets/source2018_numeric_us_with_avro_order --force-exe-build 'true' --cache-type lru,lfu,sizeSmall,sizeBig --cache-size 100 --cache-size-unit "T" --simulation-steps normal --window-start 0 --window-stop 52 --region us --cache-bandwidth 10 --cache-bandwidth-redirect 'true' --out-folder ../../results/sim_us_dataset_with_watermarks/cache_100T_10Gbit --watermarks 'true' &&
