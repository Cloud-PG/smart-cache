...
simulator sim ../../config/simulations/us_dataset_with_watermarks/100T/lru.yml &&
simulator sim ../../config/simulations/us_dataset_with_watermarks/100T/lfu.yml &&
...
# python -m Probe.qTable ../../results/sim_us_dataset_with_watermarks/100T/100T/run_full_normal/aiRL_10G_it/aiRL_10G_it_additionQtable.csv &&

# python -m Probe.qTable ../../results/sim_us_dataset_with_watermarks/100T/100T/run_full_normal/aiRL_10G_it/aiRL_10G_it_evictionQtable.csv &