...
# python -m SmartCache.sim.simulator plot ../../results/sim_italian_dataset_no_k_only_eviction/50T --plot-resolution 1280,800 --cache-bandwidth 10 --export-table 'true'

### ----- Plot tables -----

# python -m Probe.qTable ../../results/sim_italian_dataset_no_k_only_eviction/50T/run_full_normal/aiRL_10G_it/aiRL_10G_it_additionQtable.csv &&

# python -m Probe.qTable ../../results/sim_italian_dataset_no_k_only_eviction/50T/run_full_normal/aiRL_10G_it/aiRL_10G_it_evictionQtable.csv &