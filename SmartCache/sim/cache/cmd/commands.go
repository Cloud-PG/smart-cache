	...
	serveCmd := &cobra.Command{ // nolint: exhaustivestruct
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			initParameters := cache.InitParameters{
				...
				AIRLAdditionEpsilonUnleash: boolCheck(conf.Service.AI.RL.Addition.Epsilon.Unleash),
				...
				AIRLEvictionEpsilonUnleash: boolCheck(conf.Service.AI.RL.Eviction.Epsilon.Unleash),
	...
	simCmd := &cobra.Command{ // nolint: exhaustivestruct
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			initParameters := cache.InitParameters{
				...
				AIRLAdditionEpsilonUnleash: boolCheck(conf.Sim.AI.RL.Addition.Epsilon.Unleash),
				...
				AIRLEvictionEpsilonUnleash: boolCheck(conf.Sim.AI.RL.Eviction.Epsilon.Unleash),
