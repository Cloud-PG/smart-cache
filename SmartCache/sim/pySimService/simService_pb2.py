...
_SIMCACHESTATUS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dataReadOnMiss', full_name='simservice.SimCacheStatus.dataReadOnMiss', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dataDeleted', full_name='simservice.SimCacheStatus.dataDeleted', index=9,
