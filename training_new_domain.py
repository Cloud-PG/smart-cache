...
input_len = 7 + it_total_campaigns + it_total_sites
...
model_evict.add(Dense(128, input_dim= input_len))
model_evict.add(Activation('sigmoid'))
model_evict.add(Dense(256))
model_evict.add(Activation('sigmoid'))
...
if use_target_model == True:
    ...
    target_model_evict.add(Dense(128, input_dim= input_len))
    target_model_evict.add(Activation('sigmoid'))
    target_model_evict.add(Dense(256))
    target_model_evict.add(Activation('sigmoid'))
...
model_add.add(Dense(128,input_dim = input_len))
model_add.add(Activation('sigmoid'))
model_add.add(Dense(256))
model_add.add(Activation('sigmoid'))
...
if use_target_model == True:
    ...
    target_model_add.add(Dense(128,input_dim = input_len))
    target_model_add.add(Activation('sigmoid'))
    target_model_add.add(Dense(256))
    target_model_add.add(Activation('sigmoid'))
...
###### START LOOPING ############################################################################################################################
environment = cache_env_new_domain.env(
